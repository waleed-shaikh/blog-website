  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-gilroy items-center justify-start mx-auto w-full">
        <div className="bg-white-A700 flex flex-col justify-start w-auto md:w-full">
          ...
          <div className="border border-blue_gray-100 border-solid flex flex-col gap-5 h-auto items-center justify-start max-w-[676px] md:ml-[0] ml-[382px] mt-14 md:px-5 px-[140px] py-8 rounded-lg w-auto md:w-full">
          ...
          <Text
            className="h-auto md:ml-[0] ml-[383px] mt-[41px] text-blue_gray-900 text-xl w-auto"
            size="txtGilroySemiBold20"
          >
            My Articles
          </Text>
          <List
            className="flex flex-col gap-4 h-auto items-center md:ml-[0] ml-[382px] mt-[18px] md:px-5 w-auto"
