        ...
        <div className="h-[1286px] md:h-[1724px] sm:h-[3379px] md:px-5 relative w-full">
          ...
          <div className="absolute bg-white-A700 border-b border-blue_gray-100 border-solid flex md:flex-col flex-row md:gap-10 items-center justify-between p-[17px] right-[0] top-[0] w-4/5">
            ...
            <div className="bg-white-A700 flex flex-row gap-6 items-start justify-start mr-3.5 w-auto">
              <Button
                className="common-pointer cursor-pointer font-medium h-10 min-w-[161px] rounded-[20px] text-base text-center"
              ...
              <Button
                className="common-pointer cursor-pointer font-medium h-10 min-w-[146px] rounded-[20px] text-base text-center"
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    ...
                    <div className="flex flex-row font-gilroy gap-2 items-center justify-start w-3/4 md:w-full">
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[87px] text-center text-sm"
                        shape="round"
                      >
                        Ux design
                      </Button>
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[103px] text-center text-sm"
                        shape="round"
                      >
                        Ux Research
                      </Button>
                    ...
                    <div className="flex flex-row font-gilroy gap-2 items-center justify-start w-[85%] md:w-full">
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[125px] text-center text-sm"
                        shape="round"
                      >
                        Design Thinking
                      </Button>
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[90px] text-center text-sm"
                        shape="round"
                      >
                        Front-end
                      </Button>
                    ...
                    <div className="flex flex-row font-gilroy gap-2 items-center justify-start w-[84%] md:w-full">
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[177px] text-center text-sm"
                        shape="round"
                      >
                        Back-end development
                      </Button>
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[37px] text-center text-sm"
                        shape="round"
                      >
                        UI
                      </Button>
                    ...
                    <div className="flex flex-row font-gilroy items-center justify-between w-full">
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[67px] text-center text-sm"
                        shape="round"
                      >
                        Money
                      </Button>
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[79px] text-center text-sm"
                        shape="round"
                      >
                        Business
                      </Button>
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[101px] text-center text-sm"
                        shape="round"
                      >
                        Productivity
                      </Button>
                    ...
                    <div className="flex flex-row font-gilroy gap-2 items-center justify-start w-[76%] md:w-full">
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[97px] text-center text-sm"
                        shape="round"
                      >
                        Psychology
                      </Button>
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[96px] text-center text-sm"
                        shape="round"
                      >
                        Mindfullnes
                      </Button>
                    ...
                    <div className="flex flex-row font-gilroy gap-2 items-center justify-start w-[56%] md:w-full">
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[75px] text-center text-sm"
                        shape="round"
                      >
                        Science
                      </Button>
                      <Button
                        className="cursor-pointer font-medium h-7 min-w-[63px] text-center text-sm"
                        shape="round"
                      >
                        Books
                      </Button>
