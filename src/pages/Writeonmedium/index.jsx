            ...
            <header className="flex flex-col items-center justify-center md:px-5 w-full">
              <div className="border-b border-blue_gray-100 border-solid flex flex-row md:gap-10 items-center justify-between p-[17px] w-full">
                ...
                <div className="flex flex-row gap-6 items-start justify-end mr-[15px] w-[201px]">
                  <Button
                    className="common-pointer cursor-pointer font-medium h-10 min-w-[89px] rounded-[20px] text-base text-center"
                    onClick={() => navigate(-1)}
                    color="blue_gray_400"
                    size="sm"
                    variant="outline"
                  ...
                  <Button
                    className="cursor-pointer font-medium h-10 min-w-[88px] rounded-[20px] text-base text-center"
                    color="gray_900_02"
                    size="sm"
                  >
                    Publish
