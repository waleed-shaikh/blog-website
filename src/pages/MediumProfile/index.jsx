          ...
          <header className="flex flex-col items-center justify-center md:px-5 w-full">
            <div className="border-b border-blue_gray-100 border-solid flex md:flex-col flex-row md:gap-10 items-center justify-between p-[17px] w-full">
              ...
              <div className="flex flex-row gap-6 sm:hidden items-start justify-start mr-[68px] w-[331px]">
                <Button
                  className="cursor-pointer font-medium h-10 min-w-[161px] rounded-[20px] text-base text-center"
                  color="gray_900_02"
                  size="sm"
                >
                  Write on medium
                ...
                <Button
                  className="cursor-pointer font-medium h-10 min-w-[146px] rounded-[20px] text-base text-center"
                  color="gray_900_02"
                  size="sm"
                >
                  Write on dev.to
